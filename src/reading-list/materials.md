### Дополнительный материал по курсу "Основы cloud-computing"
...
#### Раздел 4 - Контейнеризация и Docker
...
* 📕 Глубокое погружение в Linux namespaces, как все устроено под капотом в Docker - [Ссылка](https://habr.com/ru/articles/458462/)
...
* 📕 Мультиконтейнерные приложения - [Ссылка](https://habr.com/ru/companies/ruvds/articles/450312/)
...
* 📕 Как разделить стадии сборки в одном DockerFile - [Ссылка](https://habr.com/ru/articles/327698/)
...
#### Раздел 5 - Промышленная Инфраструктура корп хранилищ
...
#### Раздел 6 - Cloud Native
* 📕 Основы нативной облачной архитектуры: cloud-native подход, приложения и разработка - [Ссылка](https://habr.com/ru/companies/mws/articles/731804/)
* 📕 Что такое Cloud Native? - [Ссылка](https://learn.microsoft.com/ru-ru/dotnet/architecture/cloud-native/definition)
...
#### Раздел 9 - Введение в распределенные системы 


#### Раздел 10 - Отказоустойчивость/метрики/SLA/масштабирование
...
* 📕 (EN) CQRS Design Pattern in Microservices Architectures  - [Ссылка работает с помощью трех букв](https://medium.com/design-microservices-architecture-with-patterns/cqrs-design-pattern-in-microservices-architectures-5d41e359768c)
#### Раздел 13 - Блокчейн как архитектура
* 📕 Что нам стоит блокчейн построить? - [Ссылка](https://habr.com/ru/articles/443282/)
#### Раздел 14 - Безопасность распределенных систем
...
* 📕 Построение аттестуемых и защищенных инфраструктур на базе решений VMware - [Ссылка](https://www.it-grad.ru/blog/postroenie-attestuemyx-i-zashhishhennyx-infrastruktur-na-baze-reshenij-vmware)
* 📕 Как IaaS-провайдер работает с ИБ: угрозы и защита  - [Ссылка](https://habr.com/ru/companies/1cloud/articles/342770/)
### Раздел 15 - Redis
